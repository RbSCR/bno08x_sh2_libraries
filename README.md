...
![License](https://img.shields.io/github/license/RbSCR/bno08x_sh2_driver?label=License)
...
- Tested and validated, using another ROS package, on Raspberry Pi 5 running ROS 2 Kilted (Ubuntu 24.04, aarch64) with real BNO085 hardware.
...
```bash
colcon build --packages-select bno08x_sh2_driver
```
